...
- **Zip Code:** 97201
- **Country:** USA
- **Customer Type:** Business (dropdown - select "Business" exactly)
- **Status:** Active (dropdown - select "Active" with capital A)
...
### "Validation error: Invalid status" (or similar enum errors)
- Dropdown fields are **case-sensitive**
- Valid status values: **Active**, **Inactive**, **Suspended** (exact capitalization)
- Valid customer types: **Individual**, **Business**, **Wholesale**, **Retail**
- If dropdown is empty, try refreshing the page
